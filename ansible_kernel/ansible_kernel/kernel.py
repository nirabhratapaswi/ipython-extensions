...
class AnsibleKernel(Kernel):
    ...
    def __init__(self, **kwargs):
        ...
        f = open("/home/tardis/Desktop/Ansible/Runner/inventory/hosts", "r")
        self.default_inventory = f.read()
        f.close()
        self.default_play = yaml.dump(dict(hosts='localhost',
                                           name='default',
                                           gather_facts=False))
        self.temp_dir = tempfile.mkdtemp(prefix="ansible_kernel_playbook")
        # f = open("/home/tardis/Desktop/from_ansible.txt","w+")
        # f.write("Hello World")
        # f.close()
        # self.temp_dir = "/home/tardis/Desktop/Ansible/CommonStore" # tempfile.mkdtemp(prefix="ansible_kernel_playbook")
        self.queue = None
